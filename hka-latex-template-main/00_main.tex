...
\chapterimage{Bilder_und_Co/verzeichnisse.jpg} % Table of contents heading image
...
\input{begriffs_erklärungen.tex}
...
\input{01_Einordnung_und_Zielsetzung.tex} 
\input{02_Theoretische_und_technische_Grundlagen.tex} 
\input{03_Stand_von_Forschung_und_Praxis.tex}
\input{04_Anforderungen,_Analyse_und_Bewertung.tex}
\input{05_Risiken,_Empfehlungen_und_Abschluss.tex}
\input{83_Rahmenbedingungen_für_KI-Sicherheit_in_der_Luftfahrt.tex}
%\input{90_Verwandte_Arbeiten.tex}


%\input{examples.tex}	% TODO: uncomment for final version!


%----------------------------------------------------------------------------------------
%	BIBLIOGRAPHY (wird angezeigt, wenn \cite)
%----------------------------------------------------------------------------------------
\cleardoublepage
\part*{Bibliography}
\chapterimage{Bilder_und_Co/buecherregale.jpg} % Chapter heading image
...
%----------------------------------------------------------------------------------------
%  BILDQUELLEN (alle Einträge aus image_sources.bib, ohne \cite)
%----------------------------------------------------------------------------------------
\cleardoublepage
\chapter*{Bildquellen}
\addcontentsline{toc}{chapter}{\textcolor{ThemeColor}{Bildquellen}}

\begin{refsection}[image_sources.bib]
  \nocite{*} % nimmt ALLE Einträge aus image_sources.bib auf
  \printbibliography[heading=bibempty]
\end{refsection}
%----------------------------------------------------------------------------------------
%	INDEX
