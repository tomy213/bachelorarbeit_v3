...
\subsection{F-14}
Als Bordradar wurde unter anderem ein AWG-9 verwendet, die Spezifikationen sind: \parencite{Forecast1999_AWG9_APG71}
...
Frontradar zur Abstandmessung. Toterwinkel Assistent (optional hinten quer mit dabei). 
Toterwinkel Quererkennung (unterschiedliche, gleicher Typ).
...
\begin{itemize}
  ...
  \item typische Sendeleistung im Bereich von 100 Miliwatt bis 1 Watt
  \item typischerweise wird ein FMCW Radar verwendet
\end{itemize}
...
Beispielhafte Erfahrungswerte sind bei einer eindeutigen Klassifikation ``out-of-bag'' sprich ohne Aufwand 
eine Accuracy bis zu 80 \%  . Mit geringen Feature Engineering bereits 90 bis 97 \%. 
...
pro Mission theoretisch möglich. Dadurch könnten unter idealen Voraussetzungen und besonderer Begründung 
Bereiche wie DAL C oder ASIL B möglich sein. Wenn man keine eindeutige Klassifikation sondern 
...
Beispiele &
Bord-Radar-Software, Anzeigenlogik, Safety-Monitore. &
Code-Generator, Testframework, Datenlabeling-/Auswertetool mit Nachweis-Credit. \\[4pt]
...
\section{Kritische Punkte (harte „Gatekeeper“)}
...
Im Folgenden werden die nicht vollständig abgedeckten Punkte knapp bewertet (Erfüllbarkeit + kurze Begründung).

\subsection{Teilweise abgedeckte Punkte — Erfüllbarkeit}
\begin{itemize}
