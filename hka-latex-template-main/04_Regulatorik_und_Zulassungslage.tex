\part{Regulatorik \& Zulassungslage (Policy/Standards Review)}
...
\section{Concept Paper Issue 2: Guidance für Level 1 \& 2}
Das \emph{Concept Paper Issue 2} (03/2024) konkretisiert Anforderungen für \textbf{Level 1} (Assistenzfunktionen) 
und erweitert auf \textbf{Level 2} (Human-AI-Teaming: Kooperation/Kollaboration unter menschlicher Aufsicht). 
Es vertieft „Learning Assurance“, Erklärbarkeit und ethikbasierte Bewertung, ohne die klassischen Safety-Prozesse zu ersetzen. 
\paragraph{Folgende Punkte stehen im Fokus:}
\begin{itemize}
    \item \textbf{Klare Rollenverteilung:} L1 = Unterstützung, L2 = Kooperation mit dem Menschen; Autorität und Eingriffsrechte müssen beschrieben sein.
    \item \textbf{Einsatzbereich festnageln:} Definition von Scope/Use Cases, Datenbasis und Grenzen (wann „Abstain/Unknown“).
    \item \textbf{Learning Assurance:} Herkunft/Qualität der Trainingsdaten, Änderungen am Modell, und wie Updates kontrolliert freigegeben werden.
    \item \textbf{Erklärbarkeit \& HMI}: Begründbare Ausgaben, Konfidenz-/Qualitätsanzeigen, eindeutige Degradationsmodi.
    \item \textbf{Betrieb \& Monitoring:} Drift-Überwachung, Logging, Eskalationswege; „living“ Safety Case statt Einmal-Nachweis.
\end{itemize}


\section{Guidance 2024 (Level 1 \& 2) – frühe Einsatzgrenzen}
Frühe Guidance setzt bewusst enge Grenzen: zuerst \textbf{Level 1}, anschließend ausgewählte \textbf{Level 2}-Anwendungen 
mit klarer menschlicher Aufsicht. Zuvor war der Fokus bei L1 auf \emph{offline} gelernten, „eingefrorenen“ Modellen 
und (überwiegend) \emph{supervised} Verfahren; Issue 2 erweitert den Rahmen für L2, behält aber strikte Nachweis- 
und Governance-Erwartungen bei.
\paragraph{Frühe Einsatzgrenzen.}
\begin{itemize}
  \item \textbf{Autorität begrenzt:} L1 = Mensch entscheidet und handelt; L2 = System darf Aktionen ausführen, aber immer unter Aufsicht und jederzeit übersteuerbar.
  \item \textbf{Kein Online-Lernen:} Zulässig sind \emph{offline} gelernte, zur Freigabe „eingefrorene“ Modelle; \emph{Online-/Continual Learning} ist ausdrücklich (noch) ausgeschlossen.
  \item \textbf{OD/ODD verpflichtend:} Einsatzbereich (Operational Domain/Design Domain) ist eng zu definieren; bei OoD/OoD-Daten sind Monitoring, Warnung und sicheres Verhalten gefordert.
  \item \textbf{Assurance bleibt maßgeblich:} KI-spezifische Learning-Assurance kommt \emph{on top}; Software-/Hardware-Entwicklungsassurance (z.\,B. DO-178C) bleibt anwendbar.
  \item \textbf{„Mindestens so sicher“ wie traditionell:} Ziel ist ein Sicherheitsniveau, das dem konventioneller Lösungen entspricht; es gibt keinen faktischen „Assurance-Rabatt“.
\end{itemize}

\paragraph{Bedeutung}
\begin{itemize}
  \item \textbf{Scope festnageln:} L1/L2 klar trennen (Rollen, Eingriffsrechte, HMI) und den ODD so präzise beschreiben, dass „Unknown/Abstain“ und Fallbacks eindeutig sind.
  \item \textbf{Offline-Modelle annehmen:} Updates nur kontrolliert (Freigabe \& Rollback); kein Online-Lernen – stattdessen Betriebsmonitoring und Drift-Erkennung.
  \item \textbf{Assurance-Argument führen:} Learning-Assurance \emph{zusätzlich} zu System-/SW-/HW-Assurance darstellen (Kompatibilität, Nachweise, Traceability).
  \item \textbf{OOD-Strategie zeigen:} Erkennung außerdomäniger Daten, saubere Warnungen, konservatives Verhalten und transparente Konfidenz-/Qualitätsanzeigen in der HMI.
\end{itemize}

\section{DO-178C (ED-12C) – Rolle im KI-Kontext}
...
\begin{itemize}
  ...
  \item \textbf{ISO/PAS 8800:} KI-spezifische Ergänzung zu 26262/SOTIF (Daten-/Modell-Governance, ODD/OOD, Kalibrierung, Betrieb/Updates).
  \item \textbf{ISO/IEC TR 5469:} Domänenübergreifender Leitfaden \emph{Funktionale Sicherheit \& KI} – Eigenschaften, Risiken, Methoden/Prozesse.
\end{itemize}
...
Software-Assurance & DO-178C (ED-12C) & ISO 26262 Teil SW \\
Hardware-Assurance & DO-254 & ISO 26262 Teil HW \\
Umwelt/EMV & DO-160 & Automotive Umwelt-/EMV-Normen \\
KI-Guidance & EASA AI Level 1/2 (Guidance) & ISO/PAS 8800 \\
Einsatzgrenzen & Operational Envelope & ODD (Operational Design Domain) \\
Betrieb/Änderungen & Continuing Airworthiness & Typgenehmigung + (R156) Updates \\
\hline
\end{tabular}
\end{center}
