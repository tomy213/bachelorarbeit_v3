...
\begin{itemize}
  ...
  \item \textbf{Kritikalitätsgrenzen \& Nachweise:} In der Anfangsphase kein Einsatz von AI/ML-Bestandteil in höchsten Kritikalitäten wie DAL~A/B; keine Reduktion klassischer Nachweis-Anforderungen innerhalb der AI/ML-Teile.
...
hilft es zu verstehen in wiefern diese sich bezüglich KI, Sicherheitsnachweisen oder allgemein als Branche unterscheiden oder ähneln.
...
von kleinen Drohnen bis hin zu Großraumflugzeugen, im Straßenverkehr typischerweise von 
Fußgängern bis zum Lkw. Wahrnehmung und Entfernungen sind ebenfalls 
...
\subsection*{Hardwareanforderungen für KI}
...
Die ISO 8800 \footnote{\citetitle{iso-pas-8800-2024} \parencite{iso-pas-8800-2024}}, versteht sich als Konkretisierung der ISO 26262 für KI.
