...
Die EASA ist als zuständige europäische Luftfahrtbehörde regulatorisch maßgeblich. 
Ihre Veröffentlichungen setzen den Referenzrahmen für Anforderungen und Nachweise. 
Im Folgenden werden die entsprechenden Dokumente systematisch auf Forderungen an 
KI-Nachweise untersucht und zusätzlich etablierte Normen betrachtet. Diese Dokumente 
ergänzen sich inhaltlich und weisen daher erkennbare Überlappungen auf.
...
\section{EASA AI-Guidance 2024 (Concept Paper Issue 2) – Level 1 \& 2} \footnote{\citetitle{easa-ai-concept-issue2-2024} \parencite{easa-ai-concept-issue2-2024}} \label{sec:concept_paper}
...
\section{Diskussion der Abdeckung (EASA \& ISO 8800)} \label{sec:abdeck_easa_iso}
...
\medskip
Hinweis zur Wirksamkeit: ISO/PAS 8800 verweist auf ISO 21448 (SOTIF). Einen expliziten SOTIF-Standard gibt es in der Luftfahrt nicht.
