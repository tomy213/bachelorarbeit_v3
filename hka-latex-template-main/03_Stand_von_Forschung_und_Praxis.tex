...
Der AI-Safety-Diskurs priorisiert \emph{Assurance} gegenüber reiner Benchmark-Optimierung. Wiederkehrende Motive sind: % TODO \cite{...}
\begin{itemize}
...
Detektion und Klassifikation (inkl.\ Mikrodoppler), Trennung von Ziel und Clutter, einfache Sensorfusion,
Qualitätsbewertung von Radarprodukten, kuratierte Datenauswahl/-bereinigung sowie Ableitung von Tests und Szenarien.

\paragraph{Besonderheiten.}
Seltene Ereignisse (Klassenungleichgewicht), verteilungsabhängige Eingaben (Wetter, Clutter, RFI, Aspekt) und
strikte Randbedingungen (z.\,B.\ Latenz/Verfügbarkeit bei Bordfunktionen) prägen Datenerhebung, Auswertung und Integration.

\paragraph{Reporting-Praxis.}
Statt nur Gesamtkennzahlen setzt sich eine segmentierte Darstellung nach ODD-Schnitten durch
(z.\,B.\ nach SNR, Entfernung, Wetter, Clutter), um Leistung und Grenzen kontextsensitiv zu belegen.
