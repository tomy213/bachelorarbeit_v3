...
über das Fahrzeug hat, dementsprechend die Beherschbarkeit gleich Null ist und zudem davon auszugehen ist, dass 
...
Anzumerken ist, dass hier das Gesammtsystem betrachtet wurde. Das heißt Einzelkomponenten 
sind höher einzuordnen. Wenn man bei mehreren Duzend im Gesammtsystem beteiligten Komponenten ausgeht 
und man zudem den Fehlern eine Unabhängigkeit vorraussetzt, kann man für diese Komponenten je eine 
Fehlerquote von $ 1\times10^{-6}$/h annehmen. Einzelkomponenten können somit im Bereich \textbf{DAL C bzw. ASIL B} 
oder höher einzuordnen sein. (In der Literatur werden solche KI gesteuerten Gesammtsysteme als eAI bezeichnet.)
...
\chapter{Deep Dive: ISO/PAS 8800}
...
\paragraph{Legende zur Einstufung der Relevanz bezüglich diser Arbeit}
...
die generellen Anfroderungen, nach denen die KI-Technologien sowie Architektur- und Entwicklungsmaßnahmen entschieden werden:

\begin{itemize}
  \item Rechtfertigung, dass die Sicherheitsanforderungen erfült sind.
...
Das stellt einen kleinen Wiederspruch dar, was aufzeigt, dass auch Normen iterativ verbessert werden müssen. Anzumerken ist, dass 
...
Standarts verschiedener Industrien und haben auch Einfluss auf verschiedene Punkte dieser Arbeit.

\subsection{(12) Verifikation und Validierung des KI-Systems}
Diese Kapitel geht sehr highlevel auf Verifikation und Validierung ein. Unteranderem mit einigen Anforderungen 
...
\paragraph{KI spezifische Herausforderungen mit Eklärungen}
\begin{itemize}
...
Kamera ein Objekt nicht erkennen können durch einen Absorbtionseffekt eines Objektes. 
