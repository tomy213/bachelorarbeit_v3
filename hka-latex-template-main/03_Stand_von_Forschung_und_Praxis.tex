...
\begin{itemize}
  ...
  \item \textbf{IBM Deep Blue (1997) – Schach:}
    IBMs Schachcomputer \emph{Deep Blue} besiegte 1997 den amtierenden Weltmeister Garri Kasparow. Die Praxis zeigt: KI ist 
    stark in massiver Suche und Musteraggregation, während Menschen in Wahrnehmung, Kontext und Transfer glänzen—was dem einen 
    leicht fällt, ist dem anderen schwer.
\end{itemize}
