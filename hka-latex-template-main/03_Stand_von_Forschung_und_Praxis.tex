...
\section{(6) KI im Kontext der Systemsicherheitsentwicklung angepasst auf Radarsysteme}
...
\section{(8)Assurance-Argumente für KI-Systeme}
...
\section{(9) Ableitung von KI-Sicherheitsanforderungen}
...
\section{(10) Auswahl von KI-Technologien sowie Architektur- und Entwicklungsmaßnahmen}
...
\section{(11) Datenbezogene Aspekte}
...
\section{(12) Verifikation und Validierung des KI-Systems}
...
\section{(13) Sicherheitsanalyse von KI-Systemen}
...
\section{(15) Vertrauen in die Nutzung von KI-Entwicklungsframeworks und -Softwaretools}
