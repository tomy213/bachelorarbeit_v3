...
\begin{itemize}
  ...
  \item[\dotY] (11) \textbf{Datenbezogene Aspekte:} Die Ziele sind:\\
  ...
  \item[\dotY] (12) \textbf{Verifikation und Validierung des KI-Systems:} Die Ziele sind:\\
  ...
  \item[\dotG] (13) \textbf{Sicherheitsanalyse von KI-Systemen:} Die Ziele sind:\\
  ...
  \item[\dotY] (A-H) \textbf{Anhänge (A–H):}\\
    ...
    (F){\dotG} Identifikation von Softwareeinheiten in NN-basierten Systemen\\
    (G){\dotG} Architektur- und Entwicklungsmaßnahmen für KI-Systeme\\
    (H){\dotY} Typische Leistungskennzahlen für maschinelles Lernen\\
\end{itemize}
...
ISO/PAS~8800 ergänzt die ISO~26262 für Radarsysteme, sobald ML\slash KI als Bestandteil der sicherheitsrelevanten 
