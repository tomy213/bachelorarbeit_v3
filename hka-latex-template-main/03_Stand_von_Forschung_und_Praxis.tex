...
KI findet in der militärischen Luftfahrt bereits vielfältig Anwendung (u.\,a.\ Lagebilder, Sensorik/Wahrnehmung, Mission Support).
 Mit Fokus dieser Arbeit wird z.B. bereits im Eurofighter 
eine von Henshold entwickelte Objektklassifikations KI im Radar verwendet.
Im Sinne von \emph{Dual-Use} ergeben sich Überschneidungen, von denen zivile und militärische Bereiche profitieren können.
Öffentlich zugängliche Industrieangaben deuten auf KI-gestützte Radar-Funktionen im Eurofighter-Umfeld hin; belastbare technische
Details sind jedoch nur eingeschränkt veröffentlicht.\parencite{ecrs-mk1-release}
