...
\node[box, right=of b12] (b13) {\textbf{Aviation}};
...
\node[box, below=of b23] (b33) {Ziel dieser Arbeit};

% --- Hilfskoordinaten für Tic-Tac-Toe-Linien (du zeichnest sie selbst) ---
% (benötigt \usetikzlibrary{calc})
% Vertikale Mittellinien zwischen den Spalten:
