...
\textbf{Supervised Learning (SL)} : Eingabe–Ausgabe-Paare (z.\,B. Klassifikation, Regression).\\
\textbf{Unsupervised Learning (UL)} : Strukturentdeckung ohne Labels (z.\,B. Clustering).\\
...
Für diese Arbeit sind SL und UL am wichtigsten, da RL nach EASA-Empfehlungen \footnote{\citetitle{easa-ai-concept-issue2-2024} \parencite{easa-ai-concept-issue2-2024}} 
...
Trainingsablauf (Kernidee): Daten in Mini-Batches durch das Netz schicken (Forward Pass) \(\rightarrow\) Loss mit den
...
Eine vereinfachte Darstellung klassischer Radar-Klassifikation ist, die empfangenen Rohdaten aufzubereiteten 
und in eine verarbeitbare Form zu bringen. Weiter wird eine deterministische Heuristik einprogrammiert, 
die anhand dieser aufbereiteten Daten und den dort definierten Mustern die Objekte unterscheidet. 
Diese werden anschließend dem Operator angezeigt.
...
Alternativ zum rein punktförmigen Zielen, kann man anhand wiederkehrende Muster wie zum 
Beispiel Mikro-Doppler Ziele erkennen.
...
Im vorliegenden Kapitel werden Begrifflichkeiten wie Safety und Reliability definiert. 
Sowie Vorgehen zum Nachweis der Sicherheit beziehungsweise das Vorgehen bei Assurance Cases beschrieben. 
...
Folgend werden begriffliche und methodische Grundlagen für die spätere Bewertung
...
\begin{itemize}
  ...
  \item \textbf{Nachweis statt „viel hilft viel“:} Eine Erhöhung von Parameterzahl oder Datenmenge
        kann Metriken verbessern, ersetzt jedoch nicht Assurance bzw.\ belastbare Nachweise
        zur Sicherheit.
